...
shinyUI(navbarPage("U.S. States Analysis",tabPanel("Interactive States Selection and Analysis",
        sidebarLayout(
                ...
                mainPanel(h3("Documentation :"),
                          ...
                          h4("5. " , a("ui.R & server.R files are in Aniruddha Chakraborty's Github Repository", href="https://github.com/AniruddhaChakraborty/Developing-Data-Products-Course-Project")),
                          br(),
