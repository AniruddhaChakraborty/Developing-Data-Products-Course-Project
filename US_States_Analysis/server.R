...
## Rename Columns
colnames(Anscombe)=c("Per-capita education expenditures, dollars","Per-capita income, dollars","Proportion under 18, per 1000","Proportion urban, per 1000")
colnames(USArrests)=c("Murder arrests (per 100,000)","Assault arrests (per 100,000)","Percent urban population","Rape arrests (per 100,000)")
colnames(States)=c("Region","Population: in 1,000s","SATV - Average score in the state on the verbal component of the SAT.","SATM - Average score in the state on the math component of the SAT.","Percentage of students in the state who took the SAT exam.","State spending on public education, in $1000s per student.","Average teacher's salary in the state, in $1000s.")
